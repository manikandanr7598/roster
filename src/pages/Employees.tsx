  ...
  const handleSaveEmployee = async (e: React.FormEvent) => {
    ...
    try {
      if (selectedEmployee.id) {
        ...
        setEmployees(prev => prev.map(e => e.id === selectedEmployee.id ? { ...selectedEmployee } as Employee : e));
      } else {
        // Add new employee
        const id = await addEmployee(selectedEmployee);
        const newEmployee = { ...selectedEmployee, id } as Employee;
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    onChange={(e) => setSelectedEmployee({ ...selectedEmployee, status: e.target.value as 'Active' | 'On Leave' | 'Terminated' })}
                    required
                  >
